...
based2="/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/04.MAPDATA/bayesianrealtime"
inputd2="/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/03.CALC_PERCENT/bayesian.real.time.pctl"
