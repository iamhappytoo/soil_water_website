...
inputd2="/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/03.CALC_PERCENT/vic.pctl.from.2018"
based2="/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/04.MAPDATA/vichistory"
