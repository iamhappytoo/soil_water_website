...
for ffname in glob("/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/03.CALC_PERCENT/vic.sm.from.2018/*.txt"):
	nam=basename(ffname)
#	print(ffname)
...
# prepare data
	alld = np.loadtxt("/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/03.CALC_PERCENT/vic.sm.history/"+nam)
...
#	p = pathlib.Path("/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/03.CALC_PERCENT/pctl.from.2018/")
	fout = open("/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/03.CALC_PERCENT/vic.pctl.from.2018/pctl."+nam, "w")
