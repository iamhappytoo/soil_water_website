...
inputd="/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/04.MAPDATA/vichistory/datafordates/"
outputd="/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/05.MAPPING/vichistory"
cd $inputd
file=$1
#grdfile=${file}".grd"
