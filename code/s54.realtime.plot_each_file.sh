...
inputd="/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/04.MAPDATA/realtime/datafordates/"
outputd="/raid4/forecast/pnw_sw_monitor/soil_moisture_obs_update/05.MAPPING/realtime"
cd $inputd
file=$1
#grdfile=${file}".grd"
...
#pscoast -R${minlo}/${maxlo}/${minla}/${maxla} -Jj119/1:8000000 -X1i -Y1i -Ba2f1g5:"Latitude":/a2f1g5:"Longitude"::."Soil moisture percentile (%) ${figuretitle}":WSEN  -P -K -Dh -W -S235/235/255 -G211/211/211 -A1000 -Na -Lf-122/34/35/200k > $outputd/${figurename}
#pscoast -R-125/${maxlo}/32/${maxla} -Jj119/1:8000000 -X1i -Y3i -Ba2f1g5:"Latitude":/a2f1g5:"Longitude"::."Soil moisture percentile (%) ${figuretitle}":WSEN  -P -K -Dh -W -S235/235/255 -G211/211/211 -A1000 -Na -Lf-122/34/35/200k > $outputd/${figurename}
